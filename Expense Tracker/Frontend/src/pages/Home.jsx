  ...
  return (
    <div className="HomeContainer p-7 h-screen w-full ">
      <div className="h-full w-full flex gap-7 items-center justify-between">
        ...
        <section className="homeDashboard h-full w-full flex items-center justify-between overflow-hidden">
          ...
          <aside className="w-[60%] h-full bg-white flex flex-col gap-5 px-3">
            <div>
              ...
              <div className="w-full h-fit px-2 flex flex-col gap-2">
                <span className=" w-full py-2 px-2 bg-zinc-300/40 text-red-500 flex rounded-xl items-center justify-between">
                  <h5>Rent</h5>
                  <p>-10000</p>
                </span>
                <span className="w-full py-2 px-2 bg-zinc-300/40 text-green-500 flex rounded-xl items-center justify-between">
                  <h5>Bitcoin</h5>
                  <p>+8000</p>
                </span>
                <span className="w-full py-2 px-2 bg-zinc-300/40 text-red-500 flex rounded-xl items-center justify-between">
